                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="pull-right">
                                    <a href="{{ url('/si/estados/create') }}" type="button" class="btn btn-primary link-item">
...
<script>
    $('.datatable-ajax').dataTable({
        ajax: '{{ url('si/estados/list') }}',
        columns: [
            {
                orderable: false,
                data: function(data) {
                    return `<input type="checkbox" name="row[]" value="${data['id_estado']}">`;
                }
            },
            {
                data: function(data) {
