                                ...
                                <table class="table table-hover datatable-ajax" id="table-row">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 100px; text-align: right;">Factor Compra</th>
                                            <th style="width: 100px; text-align: right;">Factor Venta</th>
                                            <th style="width: 100px; text-align: right;">Factor Promedio</th>
